# **冷門鍵盤快捷鍵整理 0726 HackMD publish ver.**
###### tags: `#不要動他！！！` `統整`

#### 0. 筆記說明

這是由共編版筆記「冷門鍵盤快捷鍵整理 0425 HackMD ver.」分支出的一個公開版筆記，筆記版本對應共編版本的 22/07/26 版。  

本筆記為 **唯讀**、**僅供檢視**。在下一個版本更新前不要做任何的修改。
...
22/07/26 HackMD publish ver.
* 從共編版本 22/07/26 做了一些適用於公開版的改動。
* 「編輯說明」改成了「筆記說明」，裡面的說明也做了修改。

22/08/30 HackMD publish ver.
* 將一個月前在共編版上做的修正加進來了。
